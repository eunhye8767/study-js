;(function () {
  ...
  const init = () => {
    ...
    $todos.addEventListener('keydown', changeEditMode) // 키보드이벤트 적용
    $todos.addEventListener('click', editTodo)
    $todos.addEventListener('keydown', editTodo) // 키보드이벤트 적용
    $todos.addEventListener('click', removeTodo)
    $todos.addEventListener('click', recommendTodo) // 추천하기
  }
