...
/**
 *  (숙제1) 여러분이 최근에 사먹은 
 *    음식의 1. 이름 2. 가격 3. 맛있는지여부를 
 *    array 자료에 담아보고 타입지정까지 해보십시오.
 * 
 ...
 *  
 *  몇개인지는 모르겠지만 true와 false가 
 *  셋째 자료부터 잔뜩 들어올 수 있다고 합니다. 
 *  tuple 타입과 spread 연산자를 써보도록 합시다. 
 */
type arrFoodType = [string, number, ...boolean[]];
let arr :arrFoodType = ['동서녹차', 4000, true, false, true, true, false, true]
 ...
 */
function 함수1(...rest: [string, boolean, ...(number|string)[]]){
  return rest;
}
함수1('a', true, 6, 3, '1', 4);
