...
/**
 * or 기호 써도 됩니다. 
 * 이제 'left' 또는 'right' 글자만 가질 수 있는 변수가 완성되었군요.
 */ 
let 방향: 'left' | 'right';
방향 = 'left';
...
/**
 * 함수도 똑같습니다. 
 * 파라미터 타입선언할 때 글자나 숫자를 집어넣으시면 
 * 그 값만 파라미터로 넣을 수 있고
 * 
 * return 타입선언할 때도 글자나 숫자를 집어넣으시면 
 * 그 값만 return할 수 있습니다.
 */
 ...
 *    - '가위', '바위', '보' 라는 문자들만 담을 수 있는 array 자료만 
 *      return 할 수 있습니다.
 ...
 */
  var 자료 = {
    /**
     * as const는 효과가 2개인데
     *    1. 타입을 object의 value로 바꿔줍니다. 
     *       (타입을 'kim'으로 바꿔줍니다)
     * 
     *    2. object안에 있는 모든 속성을 readonly로 바꿔줍니다 
     *       (변경하면 에러나게)
     * 
